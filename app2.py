...
with open('./model/MultinomialNB_KFold.pkl', 'rb') as f:
    MultinomialNB_KFold = pickle.load(f)
with open('./model/MultinomialNB_Train_Test.pkl', 'rb') as f:
    MultinomialNB_Train_Test = pickle.load(f)
# Loading the AdaBoost Classifier model
with open('./model/AdaBoost_Classifier_KFold.pkl', 'rb') as f:
    AdaBoost_Classifier_KFold = pickle.load(f)
with open('./model/AdaBoost_Classifier_Train_Test.pkl', 'rb') as f:
    AdaBoost_Classifier_Train_Test = pickle.load(f)
# Loading the Bagging Classifier model
with open('./model/Bagging_Classifier_KFold.pkl', 'rb') as f:
    Bagging_Classifier_KFold = pickle.load(f)
with open('./model/Bagging_Classifier_Train_Test.pkl', 'rb') as f:
    Bagging_Classifier_Train_Test = pickle.load(f)
# Loading the Decision Tree model
with open('./model/Decision_Tree_KFold.pkl', 'rb') as f:
    Decision_Tree_KFold = pickle.load(f)
with open('./model/Decision_Tree_Train_Test.pkl', 'rb') as f:
    Decision_Tree_Train_Test = pickle.load(f)
# Loading the GaussianNB model
with open('./model/GaussianNB_KFold.pkl', 'rb') as f:
    GaussianNB_KFold = pickle.load(f)
with open('./model/GaussianNB_TrainTest.pkl', 'rb') as f:
    GaussianNB_Train_Test = pickle.load(f)
# Loading the Gradient Boosting Classifier model
with open('./model/Gradient_Boosting_Classifier.pkl', 'rb') as f:
    Gradient_Boosting_Classifier_KFold = pickle.load(f)
with open('./model/Gradient_Boosting_Classifier_Train_Test.pkl', 'rb') as f:
    Gradient_Boosting_Classifier_Train_Test = pickle.load(f)
# Loading the KNN model
with open('./model/KNN_KFold.pkl', 'rb') as f:
    KNN_KFold = pickle.load(f)
with open('./model/KNN_Train_Test.pkl', 'rb') as f:
    KNN_Train_Test = pickle.load(f)
# Loading the Logistic Regression model
with open('./model/Logistic_Regression_KFold.pkl', 'rb') as f:
    Logistic_Regression_KFold = pickle.load(f)
with open('./model/Logistic_Regression_Train_Test.pkl', 'rb') as f:
    Logistic_Regression_Train_Test = pickle.load(f)
# Loading the Random Forest model
with open('./model/Random_Forest_KFold.pkl', 'rb') as f:
    Random_Forest_KFold = pickle.load(f)
with open('./model/Random_Forest_Train_Test.pkl', 'rb') as f:
    Random_Forest_Train_Test = pickle.load(f)
# Loading the SVC model
with open('./model/SVC_KFold.pkl', 'rb') as f:
    SVC_KFold = pickle.load(f)
with open('./model/SVC_Train_Test.pkl', 'rb') as f:
